  ...
  async loadSounds() {
    ...
    try {
      ...
      if (Platform.OS === 'web') {
        ...
        this.audioElements = {
          eat: new globalThis.Audio(require('../assets/sounds/eat.mp3')),
          gameOver: new globalThis.Audio(require('../assets/sounds/game-over.mp3')),
          move: new globalThis.Audio(require('../assets/sounds/move.mp3'))
        };
